  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        <TouchableOpacity onPress={handleBuzzer} style={styles.menuItem}>
          <Image
        ...
        <TouchableOpacity onPress={handleActivateLed} style={styles.menuItem}>
          <Image
        ...
        <TouchableOpacity onPress={handleStartRace} style={styles.menuItem}>
          <Image
