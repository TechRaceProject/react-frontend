...
const LoginRegisterScreen = ({ navigation })  => {
  ...
  const validateForm = () => {
    ...
    if (!password) {
      ...
      errors.password = 'Le mot de passe doit contenir au minimun 6 lettres.';
    }
  ...
  return (
    ...
    <View style={styles.container}>
      ...
      <View style={styles.inputContainer}>
        ...
        <TouchableOpacity onPress={() => handleSubmit()} style={styles.loginRegisterButton}>
          <Text style={styles.loginRegisterButtonText}>{loginRegisterButtonText}</Text>
        </TouchableOpacity>
      ...
      <View style={styles.signUpSignInContainer}>
        <Text style={styles.signUpSignInText}>{signUpSignInText}</Text>
        <TouchableOpacity onPress={() => toggleLoginRegister()}>
          <Text onPress={() => toggleLoginRegister()} style={styles.signUpSignInLink}>{signUpSignInLink}</Text>
        </TouchableOpacity>
      </View>
    </View>
    </>
