...
const CarVideoControlScreen = () => {
    const [joystickPosition, setJoystickPosition] = useState<Coordinates>({
        x: 0,
        y: 0,
    });
    ...
    useEffect(() => {
        isEnabledButton ? SendAutoModeCommand(1) : SendAutoModeCommand(0);
    }, [isEnabledButton]);
        ...
        <>
            ...
            <View style={styles.containerCarMode}>
                <View style={styles.flex}>
                    ...
                    <ButtonToggle
                        state={{ isEnabledButton, setIsEnabledButton }}
                    />
...
export default CarVideoControlScreen;
