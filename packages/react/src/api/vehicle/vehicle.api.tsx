import { MockingProps, ApiReturn } from '~/interfaces/utils/api.interface';
import { fetchLocalData } from '~/utils/api.utils';
...
class ApiVehicle {
    ...
    static async getVehicleStatistics(): Promise<ApiReturn> {
        const apiProps: MockingProps = {
            url: '../../data/vehicleStatistics.json',
        };
